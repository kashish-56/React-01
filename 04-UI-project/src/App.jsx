...
const App = () => {
  const users = [
     ...
     { 
       img:'https://plus.unsplash.com/premium_photo-1674513559454-35ca6435079f?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NDF8fHdvcmtpbmd8ZW58MHx8MHx8fDA%3D',
       intro:'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptas corporis sed laudantium? Alias, repellat voluptatum.',
       tag:'graduate',
       color:'black'
